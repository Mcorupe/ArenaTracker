...
//         this.close = this.close.close(this);
//     }
...
//     click() {
//         console.log('You Clicked an Item /clap');
//     }
...
//             close: this.close,
//             toggle: <button type="button" onClick={this.toggle}>Click</button>,
//             align: 'right'
//         };
//         return (
//             <DropdownMenu {...menuOptions}>
//                 <li><a href="#">Test 1</a></li>
//                 <li><button type="button" onClick={this.click}>Test2</button></li>
//             </DropdownMenu>
//         );
//     }
// }
...
// // https://github.com/mlaursen/react-dd-menu/tree/master/src/js