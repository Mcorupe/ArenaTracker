...
const classSpecModules = [
  ...
  },
  {
    ...
    theDontClick: false,
    color: "#F58CBA",
    modules: [{ key: "Holy" }, { key: "Protection" }, { key: "Retribution" }]
  },
  {
    key: "Priest",
    theDontClick: false,
    color: "#FFFFFF",
    modules: [{ key: "Discipline" }, { key: "Holy" }, { key: "Shadow" }]
  },
  {
    key: "Rogue",
    theDontClick: false,
  ...
  },
  {
    ...
    theDontClick: false,
    color: "#0070DE",
    modules: [{ key: "Elemental" }, { key: "Enhance" }, { key: "Restoration" }]
  },
  {
    key: "Warlock",
    theDontClick: false,
          ...
          <div className="ccChain">
            <select value={this.state.value2} onChange={this.handleChange}>
              ...
              <option value="placeholder3">
                shitshow feature im going to hate later
              </option>
            </select>
          </div>
        </div>
